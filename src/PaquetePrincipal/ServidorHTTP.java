...
class ServidorHTTP {
  ...
  public static void main(String[] args) throws IOException, Exception {
    ...
    try {
        ...
        while (true) {
          ...
          //crea un nuevo hilo para despacharla por el socketCliente asignado
          Thread hilo = new HiloDespachador(socCliente);
   ...
   */
    ...
    /**
     * Método para el Ejercicio 1 de la Tarea 5 de PSP. 
     * Le pasamos una fecha y la formateamos para poder pasarla como string
     * @param fecha
     * @return 
     */
    private static String formatearFechaEjercicio1(Date fecha) {
        SimpleDateFormat formatoFecha = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss z");
    ...
    private static class HiloDespachador extends Thread {
        ...
        private void procesaPeticion(Socket socketCliente) throws IOException {
            String peticion;
            String html;
            ...
            if (peticion.startsWith("GET")) {
              ...
              String fechaHTTP = formatearFechaEjercicio1(fechaActual);
              ...
              if (peticion.length() == 0 || peticion.equals("/")) {
                ...
                //Hacemos la parte del Ejercicio 1
                printWriter.println("Date: " + fechaHTTP);
                //Fin parte ejercicio 1
              ...
              System.out.println("Peticion atendida con exito para el cliente: " + socketCliente.getInetAddress());
            }
        }
